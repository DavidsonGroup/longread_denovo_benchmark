...
raw_reads='${PWD}/../A549_MCF7_directRNA_merged.fastq.gz'
num_cores=48
...
name=$(basename $raw_reads _filtered.fastq.gz)

## use -uf -k14 for direct RNA as suggested
minimap2 -ax splice -I 1000G -uf -k14 -t $num_cores --junc-bed $junc $genome $raw_reads | samtools sort -@ $num_cores -O BAM -o ${name}_sorted.bam
