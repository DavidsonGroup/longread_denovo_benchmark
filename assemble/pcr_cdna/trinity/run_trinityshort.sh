...
read1='/home/users/allstaff/yan.a/vast_scratch/dong/trinitystranded/Ilu_merged_R1.fq.gz'
read2='/home/users/allstaff/yan.a/vast_scratch/dong/trinitystranded/Ilu_merged_R2.fq.gz'

singularity exec --bind $binddir -e /stornext/Bioinf/data/lab_davidson/yan.a/software/trinityrnaseq.v2.15.1.simg Trinity \
          --seqType fq --SS_lib_type RF --max_memory 480G --CPU ${num_cores} \
