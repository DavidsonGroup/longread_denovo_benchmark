...
setwd("~/davidson_longread/yan.a/simulation_20240501/R_revise/")

args <- c('~/vast_scratch/sqanti3_bambu/sqanti3_results/sim05/isonform/',
          '~/vast_scratch/sqanti3_bambu/sqanti3_results/sim05/rattle/',
          '~/vast_scratch/sqanti3_bambu/sqanti3_results/sim05/rnabloom2/',
          '~/vast_scratch/sqanti3_bambu/sqanti3_results/sim05/trinity/',
          '~/vast_scratch/sqanti3_bambu/sqanti3_results/sim05/rnabloom2hybrid/',
          '~/vast_scratch/sqanti3_bambu/sqanti3_results/sim05/rnaspades/'
)

# dirs <- list.dirs(args, recursive = F, full.names = T)

sqanti_files <- list.files(args, 'unstranded_classification.txt', 
...
names(sqanti_summary2) <- c('isonform',
                            'rattle',
                            'rnabloom2', 'rnabloom2hybrid','rnaspades','trinity')
...
dte <- dte[ c('isonform_isonclust_onts',
              'rattle_rattle_onts', 
              'rnabloom2_corset_onts', 'rnabloom2hybrid_corset_sum','rnaspades_rnaspades_sum','trinity_trinity_map')]
